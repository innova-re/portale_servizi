...
--
-- Host: 127.0.0.1
-- Generato il: Feb 06, 2014 alle 11:06
...
INSERT INTO `afferenza` (`id`, `nome`, `descrizione`) VALUES
(1, 'Cesar', 'Cesar'),
(2, 'Polilab', 'Polilab'),
(3, 'Dipartimento', 'Dipartimento'),
(4, 'Laboratori didattici', 'Laboratori didattici'),
(5, 'Consorzi interdipartimentali', 'Consorzi interdipartimentali');
...
CREATE TABLE IF NOT EXISTS `ente` (
  ...
  `descrizione` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Ente di appartenenza come Unica, Sardegnaricerche o UniSS' AUTO_INCREMENT=4 ;

--
-- Dump dei dati per la tabella `ente`
--

INSERT INTO `ente` (`id`, `nome`, `descrizione`) VALUES
(1, 'Universita degli Studi di Cagliari', 'Universita degli Studi di Cagliari'),
(2, 'Sardegnaricerche', 'Sardegnaricerche'),
(3, 'Universita Degli Studi di Sassari', 'Universita Degli Studi di Sassari');
...
INSERT INTO `laboratorio` (`id_laboratorio`, `id_settore`, `id_ente`, `id_afferenza`, `nome`, `centro`, `afferenza`, `facolta`, `dipartimento`, `sezione`, `sede`, `sede_citta`, `gps_lat`, `gps_lng`, `ubicazione`, `descrizione`, `telefono`, `web`, `info`, `responsabile`, `referente`, `attivita_esterna`, `attivita_esterna_tipol`, `regolam_accesso`, `regolam_accesso_atti`) VALUES
(1, 1, 1, 1, 'Lab. Neurobiologia', 'CA', 'CeSAR', 'Facoltà di Biologia e Farmacia', 'Scienze', 'Citomorfologia', 'Cittadella Universitaria', 'Monserrato', NULL, '0.0000000', NULL, NULL, '', '', 'X X| X.X@unica.it - Y Y| X.X@unica.it', 10001, 0, 0, '', 0, ''),
(2, 1, 1, 1, 'Laboratorio prova 1', '', '', '', '', '', '', '', NULL, NULL, '', '', '', '', '', NULL, NULL, NULL, '', NULL, '');
...
--
-- Struttura della tabella `laboratorio_has_afferenza`
--

CREATE TABLE IF NOT EXISTS `laboratorio_has_afferenza` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_laboratorio` int(11) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Relazione uno a molti tra laboratorio e piu afferenze' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Struttura della tabella `laboratorio_servizi`
--

CREATE TABLE IF NOT EXISTS `laboratorio_servizi` (
...
--
-- Struttura della tabella `laboratorio_strumenti`
--

CREATE TABLE IF NOT EXISTS `laboratorio_strumenti` (
  `id_laboratorio` int(11) NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `laboratorio_tecnici`
--

CREATE TABLE IF NOT EXISTS `laboratorio_tecnici` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_laboratorio` int(11) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Elenco tecnici per ogni laboratorio' AUTO_INCREMENT=1 ;
...
--
-- Struttura della tabella `strumentilab`
--

CREATE TABLE IF NOT EXISTS `strumentilab` (
  `id_strumento` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `tipologia_strumenti`
--

CREATE TABLE IF NOT EXISTS `tipologia_strumenti` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) NOT NULL DEFAULT '',
  `descrizione` varchar(200) DEFAULT NULL,
  `note` varchar(200) DEFAULT NULL,
...
ALTER TABLE `laboratorio`
  ADD CONSTRAINT `fk1settore` FOREIGN KEY (`id_settore`) REFERENCES `settore` (`id_settore`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_laboratorio_2` FOREIGN KEY (`id_ente`) REFERENCES `ente` (`id`),
  ADD CONSTRAINT `FK_laboratorio_3` FOREIGN KEY (`id_afferenza`) REFERENCES `afferenza` (`id`);

--
-- Limiti per la tabella `laboratorio_has_afferenza`
--
ALTER TABLE `laboratorio_has_afferenza`
  ADD CONSTRAINT `FK_laboratorio_has_afferenza_2` FOREIGN KEY (`id_afferenza`) REFERENCES `afferenza` (`id`),
  ADD CONSTRAINT `FK_laboratorio_has_afferenza_1` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id_laboratorio`);

--
-- Limiti per la tabella `laboratorio_servizi`
--
ALTER TABLE `laboratorio_servizi`
  ADD CONSTRAINT `FK_laboratorio_servizi_1` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id_laboratorio`);

--
-- Limiti per la tabella `laboratorio_strumenti`
--
ALTER TABLE `laboratorio_strumenti`
  ADD CONSTRAINT `FK_laboratorio` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id_laboratorio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_laboratorio_strumenti_2` FOREIGN KEY (`id_strumento`) REFERENCES `strumenti` (`id_strumento`);

--
-- Limiti per la tabella `laboratorio_tecnici`
--
ALTER TABLE `laboratorio_tecnici`
  ADD CONSTRAINT `FK_laboratorio_tecnici_1` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id_laboratorio`);

--
-- Limiti per la tabella `strumentilab`
--
ALTER TABLE `strumentilab`
  ADD CONSTRAINT `FK_strumentilab_1` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id_laboratorio`);
